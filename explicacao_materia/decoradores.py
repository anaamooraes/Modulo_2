...
class MeuDecoradorDeClasse:
  ...
  segunda_funcao()
    ...
    #Muito usado para consultar se o usuario está logado na minha plataforma, podemos criar um decorador de autenticação e colocar antes das funcionalidades. 